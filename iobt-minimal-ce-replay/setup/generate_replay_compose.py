...
def main() -> None:
    ...
    ap.add_argument("--yolo-debug-images", dest="yolo_debug_images", action="store_true", default=True, help="Publish low-rate YOLO annotated JPEG frames to MQTT for the /device web display. Default is on for debugging.")
    ap.add_argument("--no-yolo-debug-images", dest="yolo_debug_images", action="store_false", help="Disable YOLO annotated debug images.")
    ...
    ap.add_argument("--yolo-debug-status", dest="yolo_debug_status", action="store_true", default=True, help="Publish synthetic YOLO health/debug status under /debug/<node>/analytics/yolo/status. Default is on for debugging.")
    ap.add_argument("--no-yolo-debug-status", dest="yolo_debug_status", action="store_false", help="Disable YOLO synthetic debug status.")
    ap.add_argument("--yolo-frame-debug", dest="yolo_frame_debug", action="store_true", default=True, help="Publish a 1Hz /debug/<node>/analytics/yolo/frame probe after decoded ZED frames arrive. Default is on for debugging.")
    ap.add_argument("--no-yolo-frame-debug", dest="yolo_frame_debug", action="store_false", help="Disable YOLO frame-input debug probe.")
    ap.add_argument("--audio-debug-status", dest="audio_debug_status", action="store_true", default=True, help="Publish synthetic audio-detector health/debug status under /debug/<node>/audio_detector/status. Default is on for debugging.")
    ap.add_argument("--no-audio-debug-status", dest="audio_debug_status", action="store_false", help="Disable audio-detector synthetic debug status.")

#!/usr/bin/env python3
"""Submit a Phase-7 vehicle predicate candidate to the FABLE orchestrator."""
...
from fable.distributed.demo import build_replay_vehicle_candidate
...
def main() -> int:
    ...
    parser.add_argument("--source", default="orin11_camera")
    parser.add_argument("--predicate", default="PASSES", choices=("PASSES", "MOVING", "STOPPED", "FOLLOWS"))
    parser.add_argument("--leader-id", help="Required for FOLLOWS; use the scoped or canonical leader binding expected by the demand.")
    parser.add_argument("--reference-id", default="camera_a_gate")
    parser.add_argument("--request-id", default="replay_vehicle_demo")
    parser.add_argument(
        "--event-start",
    ...
    candidate = build_replay_vehicle_candidate(

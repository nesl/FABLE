...
def run_topology(topo: NetWaggleTopology, *, hold: bool, no_cli: bool) -> None:
    net = None
    should_stop = False
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        topo = topo.with_profile(profile)
        ...
        if args.dry_run:
            return 0
        sudo_check()
        run_topology(topo, hold=args.hold or args.no_cli, no_cli=args.no_cli)
        return 0

"""Small production-shaped demo builders used by the replay integration tools.

The functions in this module create ordinary Phase-5 records; there is no
special execution path in the orchestrator for demos.
"""
